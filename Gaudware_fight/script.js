...
// Fonction commune pour mettre à jour la position
function updateCubePosition(clientX, clientY) {
    // Calcul des positions avec limites
    ...
    // Détection de collision avec la zone de dépôt
...
function startDrag(clientX, clientY) {
    isDragging = true;
    offsetX = clientX - cube.getBoundingClientRect().left;
    offsetY = clientY - cube.getBoundingClientRect().top;
...
// Fonction utilitaire pour la détection de collision
